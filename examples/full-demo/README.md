...
| Node editor | Horizontal/vertical flow, obstacle-routed links, typed ports, drag, pan, zoom, selection, snapping, inline typed parameters, per-node settings, read-only mode, JSON import/export |
