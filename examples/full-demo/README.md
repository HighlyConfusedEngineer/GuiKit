...
| Editors | Rich text, code, JSON, property, image, query, timeline, diagram, theme-token, translation, collaboration, files, analysis, automation, AI, plugin, accessibility, test, document, and design-system surfaces |
